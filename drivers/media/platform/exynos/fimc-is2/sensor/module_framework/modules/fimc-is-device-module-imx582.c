...
static struct fimc_is_sensor_cfg config_imx582[] = {
	/* Remosaic Full For Single Still Remosaic Capture */
	FIMC_IS_SENSOR_CFG_EX(8000, 6000,  15, 0, 0, CSI_DATA_LANES_4, 2184, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(4000, 3000,  30, 0, 1, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4000, 3000),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING,  0, 0),
		VC_IN(1, HW_FORMAT_RAW10, 992,  1488),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING,  0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER,  VC_MIPISTAT, 992, 1488),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER,  VC_PRIVATE,  992, 1488)),
	FIMC_IS_SENSOR_CFG_EX(4000, 2256,  30, 0, 2, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(4000, 1952,  30, 0, 3, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(4000, 1844,  30, 0, 4, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(4000, 1800,  30, 0, 5, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(3664, 3000,  30, 0, 6, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(3000, 3000,  30, 0, 7, CSI_DATA_LANES_4, 2058, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
